  ...
  <link rel="shortcut icon" href="/images/Favicon-tonda.png" type="image/png"/>
               <div id="select-view-cucina" style="text-align: center;">
                ...
                <div class="dropdown d-flex  justify-content-center" style="text-align:center !important; ">
                       ...
                       <button class="btn btn-primary btn-lg px-4 border border-4 border border-primary fs-3 font-Montserrat fw-light-bold "  onclick="location.href=`../general/index.php`;">  Home</button>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
  <link rel="shortcut icon" href="/images/Favicon-tonda.png" type="image/png"/>
     ...
     <button class="btn btn-menusopra btn-lg px-4 border border-4 border border-menusopra fs-3 font-Montserrat fw-light-bold " style="background-color: #ededed !important; border-color:  #ededed !important; color: black; margin-right: 3%" onclick="location.href=`/ordini-tutti-pizzeria`;"> Cucina</button>
                <button class="btn btn-menusopra btn-lg px-4 border border-4 border border-menusopra fs-3 font-Montserrat fw-light-bold " style="background-color: #ededed !important; border-color:  #ededed !important; color: black" onclick="location.href=`http://michele-media.it/general/`;"> Generale</button>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
  <link rel="shortcut icon" href="/images/Favicon-tonda.png" type="image/png"/>
    ...
    <li>
    <a  style="width:100% !important;" class="btn btn-outline-primary fw-bold fs-4" href="http://michele-media.it/ordini-tutti/">CUCINA</a></li>
    <hr style="width:100%;">
    <li>
    <a class="btn btn-outline-primary fw-bold fs-4" href="http://michele-media.it/ordini-tutti-pizzeria/">SPIAGGIA</a></li>
  </ul>
