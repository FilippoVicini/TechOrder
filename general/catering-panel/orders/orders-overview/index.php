...
if (mysqli_num_rows($tables_result) > 0) {
    while ($table = mysqli_fetch_assoc($tables_result)) {
        ...
        if (mysqli_num_rows($orders_result) > 0) {
            ...
            echo '<div class="piccola_tavoli_fighi_cucina col-auto pop" style="display: inline-block; padding-bottom:10px;" onclick="window.location=`' .
            ...
            while ($order = mysqli_fetch_assoc($orders_result)) {
                ...
                if (mysqli_num_rows($food_result) > 0) {
                    while ($food = mysqli_fetch_assoc($food_result)) {
                        echo '<div style="font-size: 14" class="badge ' .
                            $bgcolor .
                            ' text-wrap mx-2 my-1" >';
