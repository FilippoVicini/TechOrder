...
nav4(1); ?>
               ...
               <div class="container-fluid">
                        ...
                        <div class="card h-full">
                           <div class="card-body">
                              <div class="card-title d-flex align-items-center">
                                 <h5 class="mb-0" style="color: #06c">Pannello di Controllo</h5>
                              ...
                              <div class="list-group gap-4">
                                 ...
                                 <div class="list-group-item d-flex align-items-center border rounded">
                                    <div class="me-4">
                                       <div class="avatar rounded-circle"><i class="material-icons" style="font-size: 30px; color: #6b7b93">hotel</i></div>
                                    </div>
                                    <div class="flex-fill"><a href="./hotel-panel/" class="d-block h6 font-semibold mb-1"> Clienti Hotel</a><span class="d-block text-sm text-muted">Potrai visualizzare ed associare i QR-code al nome dei clienti nella stanza.</span></div>
                                    <div class="ms-auto text-end">
                  ...
                  <div class="row g-6 mb-6" style="margin-right:2%; margin-left: 2%">
                   ...
                   <div class="card"  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#catering-modal">   
                           <div class="card-body">
                              <div class="row">
                                 <div class="col"><span class="h6 font-semibold text-muted text-sm d-block mb-2">ordinazioni </span> <span class="h3 font-bold mb-0"  >Catering</span></div>
                                 <div class="col-auto">
      ...
      <div class="modal-footer">
                     ...
                     <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card"  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#magazzino-modal">
                           <div class="card-body">
                              <div class="row">
                                 <div class="col"><span class="h6 font-semibold text-muted text-sm d-block mb-2">Elementi</span> <span class="h3 font-bold mb-0">Magazzino </span></div>
                                <div class="col-auto">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
                     ...
                     <div class="col-xl-3 col-sm-6 col-12">
                           <div class="card"   type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Hotel-modal">
                           <div class="card-body">
                              <div class="row">
                                 <div class="col"><span class="h6 font-semibold text-muted text-sm d-block mb-2">Hotel</span> <span class="h3 font-bold mb-0"> Hotel</span></div>
                                 <div class="col-auto">
                                    <div  style="background-color: #ca6703!important; "class="icon icon-shape bg-primary text-white text-lg rounded-circle"><i class="material-icons">hotel</i></div>
                                 </div>
                              </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Sezioni Hotel</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div >
         <button style="margin:10px;" type="button" class="btn btn-secondary" onclick="location.href='http://michele-media.it/general/hotel-panel/rooms/';">Camere</button>
                 <button style="margin:10px;" type="button" class="btn btn-secondary" onclick="location.href='http://michele-media.it/general/hotel-panel/clients/';">Client</button>
                   <button style="margin:10px;" type="button" class="btn btn-secondary" >Channel Manager</button>
      </div>
      <div class="modal-footer">
