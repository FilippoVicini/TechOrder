...
$table_link = 'http://michele-media.it/menu/?r=' . $table_id . ''; 
...
$menu_id=$_GET['m'];
$home_link = 'http://michele-media.it/intromenu/?r=' . $table_id . ''; 
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ' . $food["description"]. '<hr>
        <p class="fw-bold">Ingredienti:</p>';
        $recipe = json_decode($food['recipe']);
